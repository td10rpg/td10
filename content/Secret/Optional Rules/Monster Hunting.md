...
## Monster Harvest Table

| d5  | Resource Category   | Example Harvests                               |
| --- | ------------------- | ---------------------------------------------- |
...
| 9   | Rare          |
| 10  | Extraordinary |
>**Note:** this table represents both quality and yield, with extraordinary describing either a high yield or exception quality, and poor either a low yield or dismal quality; either way, usability is the chief indicator. 
## Example Results

| Creature       | Harvest Result                      | Interpretation                |
| -------------- | ----------------------------------- | ----------------------------- |
