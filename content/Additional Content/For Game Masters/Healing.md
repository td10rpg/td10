---
permalink: additional/gm/healing
---
# The Healing Arts
*or, Much Ado About Healing*

Nearly every character possesses basic life-saving skills that enable them to treat wounds—either their own or another's. Some characters possess additional faculties, including magical, enabling them to treat wounds using different means.

A character may treat as many patients as there are time and resources available, but each patient may only be treated once per four hours. A failed heal check, or a check yielding only middling results, does not represent the *healer* failing to heal the patient, but rather the *wound* failing to respond to the best treatment available under the current conditions.
## The Healing Process
There are generally two kinds of healing: standard and magical.
### Standard Healing
Standard healing is as simple as conducting an Intellect Check (+1 bonus with the *heal* skill) against an average Toughness of 5. Standard healing is a knowledge-based art, akin to first aid, and may be performed both on others and one's self.
